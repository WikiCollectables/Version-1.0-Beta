...
class SpecialPage
{
	...
	static public $mList = array(
		...
		'ArticleswiththeMostAds'           => array( 'SpecialPage', 'ArticleswiththeMostAds' ),
      'GalleryofNewAdFiles'           => array( 'SpecialPage', 'GalleryofNewAdFiles' ), 
	);
	...
	static function initList() {
		...
		//echo "speial pages = <pre>" .print_r($wgSpecialPages); echo "</pre>"; 
