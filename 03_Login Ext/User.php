...
// Enhanced User Login Extension Code Ends Here -->
	...
	var $mId, $mName, $mRealName, $mPassword, $mNewpassword, $mNewpassTime, 
		...
		$mEmailToken, $mEmailTokenExpires, $mRegistration,

// Enhanced User Login Extension Code Starts Here -->
		$mUserlastname, $mUserbusiness, $mUseraddress1, $mUseraddress2, $mUsercity, $mUserstate, $mUserzip, $mUsercountry, $mUsercurrency, $mUserbusiness_ship, $mUseraddress1_ship, $mUsercity_ship, $mUserstate_ship, $mUserzip_ship, $mUsercountry_ship, $mPaymentaccepttype,
		$mGroups;
// Enhanced User Login Extension Code Ends Here -->
...
// Enhanced User Login Extension Code Starts Here -->
		...
		$this->mUserbusiness_ship = '';
		$this->mUseraddress1_ship = '';
		$this->mUsercity_ship = '';
		$this->mUserstate_ship = '';
		$this->mUserzip_ship = '';
		$this->mUsercountry_ship = '';

		$this->mPaymentaccepttype = '';
// Enhanced User Login Extension Code Ends Here -->
...
// Enhanced User Login Extension Code Starts Here -->
			$this->mUserlastname = $s->userlastname;
			$this->mUserbusiness = $s->userbusiness;
			$this->mUseraddress1 = $s->useraddress1;
			$this->mUseraddress2 = $s->useraddress2;
			$this->mUsercity = $s->usercity;
			$this->mUserstate = $s->userstate;
			$this->mUserzip = $s->userzip;
			$this->mUsercountry = $s->usercountry;
			$this->mUsercurrency = $s->usercurrency;

			$this->mUserbusiness_ship = $s->userbusiness_ship;
			$this->mUseraddress1_ship = $s->useraddress1_ship;
			$this->mUsercity_ship = $s->usercity_ship;
			$this->mUserstate_ship = $s->userstate_ship;
			$this->mUserzip_ship = $s->userzip_ship;
			$this->mUsercountry_ship = $s->usercountry_ship;
			
			$this->mPaymentaccepttype = $s->paymentaccepttype;
// Enhanced User Login Extension Code Ends Here -->
...
// Enhanced User Login Extension Code Starts Here -->
				'userlastname' => $this->mUserlastname,
				'userbusiness' => $this->mUserbusiness,
				'useraddress1' => $this->mUseraddress1,
				'useraddress2' => $this->mUseraddress2,
				'usercity' => $this->mUsercity,
				'userstate' => $this->mUserstate,
				'userzip' => $this->mUserzip,
				'usercountry' => $this->mUsercountry,
				'usercurrency' => $this->mUsercurrency,

				'userbusiness_ship' => $this->mUserbusiness_ship,
				'useraddress1_ship' => $this->mUseraddress1_ship,
				'usercity_ship' => $this->mUsercity_ship,
				'userstate_ship' => $this->mUserstate_ship,
				'userzip_ship' => $this->mUserzip_ship,
				'usercountry_ship' => $this->mUsercountry_ship,

				'paymentaccepttype' => $this->mPaymentaccepttype
// Enhanced User Login Extension Code Ends Here -->
...
// Enhanced User Login Extension Code Starts Here -->
	...
	/**
	 * Checks if a user with the given email exists, returns the ID
	 */
	function idForEmail($email) {
		...
		$dbr =& wfGetDB( DB_SLAVE );
		$id = $dbr->selectField( 'user', 'user_id', array( 'user_email' => $s ), __METHOD__ );
// Enhanced User Login Extension Code Ends Here -->
		if ( $id === false ) {
			$id = 0;
		}
...
// Enhanced User Login Extension Code Starts Here -->
			'userlastname' => $user->mUserlastname,
			'userbusiness' => $user->mUserbusiness,
			'useraddress1' => $user->mUseraddress1,
			'useraddress2' => $user->mUseraddress2,
			'usercity' => $user->mUsercity,
			'userstate' => $user->mUserstate,
			'userzip' => $user->mUserzip,
			'usercountry' => $user->mUsercountry,
			'usercurrency' => $user->mUsercurrency,

			'userbusiness_ship' => $user->mUserbusiness_ship,
			'useraddress1_ship' => $user->mUseraddress1_ship,
			'usercity_ship' => $user->mUsercity_ship,
			'userstate_ship' => $user->mUserstate_ship,
			'userzip_ship' => $user->mUserzip_ship,
			'usercountry_ship' => $user->mUsercountry_ship,
			
			'paymentaccepttype' => $user->mPaymentaccepttype,
// Enhanced User Login Extension Code Ends Here -->
	 ...
	 */
// Enhanced User Login Extension Code Starts Here -->
	function addToDatabase($escrow_arr) {
		$this->load();
		if($escrow_arr[mAddress1] != "")
		{
			$this->mUserlastname = $escrow_arr[mLastname];
			$this->mUserbusiness = $escrow_arr[mBusiness];
			$this->mUseraddress1 = $escrow_arr[mAddress1];
			$this->mUseraddress2 = $escrow_arr[mAddress2];
			$this->mUsercity = $escrow_arr[mCity];
			$this->mUserstate = $escrow_arr[mState];
			$this->mUserzip = $escrow_arr[mZip];
			$this->mUsercountry = $escrow_arr[mCountry];
			$this->mUsercurrency = $escrow_arr[mCurrency];

			$this->mUserbusiness_ship = $escrow_arr[mBusiness_ship];
			$this->mUseraddress1_ship = $escrow_arr[mAddress1_ship];
			$this->mUsercity_ship = $escrow_arr[mCity_ship];
			$this->mUserstate_ship = $escrow_arr[mState_ship];
			$this->mUserzip_ship = $escrow_arr[mZip_ship];
			$this->mUsercountry_ship = $escrow_arr[mCountry_ship];
			
			$this->mPaymentaccepttype = $escrow_arr[mPermanentAcceptType];
		}
// Enhanced User Login Extension Code Ends Here -->
// Enhanced User Login Extension DELETION Starts Here -->
//	function addToDatabase() {
//		$this->load();
// Enhanced User Login Extension DELETION Ends Here -->
		$dbw = wfGetDB( DB_MASTER );
		$seqVal = $dbw->nextSequenceValue( 'user_user_id_seq' );
// Enhanced User Login Extension Code Starts Here -->
		if (trim($escrow_arr[mEscrowId]) == "")
		{
// Enhanced User Login Extension Code Ends Here -->
		$dbw->insert( 'user',
			array(
...
// Enhanced User Login Extension Code Starts Here -->
		...
		else
		{
			$sql = "select s.user_id sid, b.user_id bid, s.user_registration sregdate, b.user_registration bregdate 
						...
						where e.id='" . trim($escrow_arr[mEscrowId]) . "' and e.seller_id=s.user_id and e.buyer_id=b.user_id";
			...
			$sql="update user 
						set user_name='".$this->mName."', user_password='".$this->mPassword."', 
						user_real_name='".$this->mRealName."', user_email='".$this->mEmail."', userlastname='".$this->mUserlastname."', userbusiness='".$this->mUserbusiness."', 
						useraddress1='".$this->mUseraddress1."', useraddress2='".$this->mUseraddress2."', usercity='".$this->mUsercity."', userstate='".$this->mUserstate."', 
						userzip='".$this->mUserzip."', usercountry='".$this->mUsercountry."', usercurrency='".$this->mUsercurrency."', userbusiness_ship='".$this->mUserbusiness_ship."', 
						useraddress1_ship='".$this->mUseraddress1_ship."', usercity_ship='".$this->mUsercity_ship."', userstate_ship='".$this->mUserstate_ship."', 
						userzip_ship='".$this->mUserzip_ship."', usercountry_ship='".$this->mUsercountry_ship."', paymentaccepttype='".$this->mPaymentaccepttype."', 
						user_registration ='".$dbw->timestamp( $this->mRegistration )."' 
